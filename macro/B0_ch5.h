...
Int_t B0_ch5::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t B0_ch5::LoadTree(Long64_t entry)
{
...
void B0_ch5::Show(Long64_t entry)
{
