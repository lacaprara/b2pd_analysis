...
void channel(TCanvas* c, float x=0.5, float y=0.96) {
  ...
  tch->SetTextAlign(21);
  TString channel("B^{0}#rightarrow#eta'( #eta(#gamma#gamma) #pi^{+}#pi^{-}) K^{0}_{S}(#pi^{0}#pi^{0})");
  c->cd();
...
void plot_ch2() {
  TFile* hfile=TFile::Open("Histo_ch2.root");
  ...
  if (false) {
    ...
    bool hLog[13]={false,false,false,false,false,true,true,true,true,false,true,true,true};
    float hCutLow[13] ={5.25,-0.15,0.48,0.93,0.1 ,0.42,0.2,-0.08,-0.15,1,1E-3,1E-3,1E-3};
    float hCutHigh[13]={5.29, 0.25,0.57,0.98,0.15,0.52,1.0,+0.08,+0.15,4,1E-3,1E-3,1E-3};
  ...
  if(true) {
    ...
    bool hLog[6]={false,false,false,false,false,true};
    float hCutLow[6] ={5.25,-0.15,0.48,0.93,0.1 ,0.42};
    float hCutHigh[6]={5.29, 0.25,0.57,0.98,0.15,0.52};
    ...
    c1->Print("Ch2_distr.pdf");
    c1->Print("Ch2_distr.png");
    ...
    c2->Print("Ch2_best_distr.pdf");
    c2->Print("Ch2_best_distr.png");
  }
  ...
  if (true) {
    ...
    cEvents->Print("Ch2_events.pdf");
    cEvents->Print("Ch2_events.png");
  }
  ...
  cDt->Print("Ch2_Dt.pdf");
  cDt->Print("Ch2_Dt.png");
  ...
  cAsym->Print("Ch2_Asym.pdf");
  cAsym->Print("Ch2_Asym.png");
}
