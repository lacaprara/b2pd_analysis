...
cp ../SkimEtaPrK0_ch${channel}.py .
cp ../${fileList} .
time basf2 SkimEtaPrK0_ch${channel}.py $numFiles $firstFile $what
mv ${channelName}_skim_${what}.root ${channelName}_skim_${what}_${job}.root
